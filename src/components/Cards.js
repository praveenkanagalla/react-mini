...
const Cards = ({onArticleClick}) => {
  ...
  const articleList = [...items].reverse().map(article => <article className='article__container card__container'
  key={article.toString()} value={article} onClick={() => { onArticleClick(article) } }>
